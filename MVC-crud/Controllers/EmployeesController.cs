...
namespace MVC_crud.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Name,Address,Salary,DeptId")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Empid,Name,Address,Salary,DeptId")] Employee employee)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult Delete(int? id)
        {
            ...
            Employee employee = boEmp.Delete(id.Value);
            if (employee == null)
            {
                return HttpNotFound();
            }
